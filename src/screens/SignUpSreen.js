...
const SignUpScreen = ({ navigation }) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={isSmallScreen}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity onPress={toggleConfirmPasswordVisibility} style={styles.eyeIcon}>
            <Feather name={confirmPasswordVisible ? "eye" : "eye-off"} size={24} color="#B0B0B0" />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.socialIconsContainer}>
        <TouchableOpacity onPress={() => console.log('Google signup pressed')} activeOpacity={0.6}>
          <Image source={require('../../assets/google-logo.png')} style={styles.googleIcon} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => console.log('Facebook signup pressed')} activeOpacity={0.6}>
          <FontAwesome name="facebook" size={32} color="#3B5998" style={styles.socialIcon} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => console.log('Twitter signup pressed')} activeOpacity={0.6}>
          <FontAwesome name="twitter" size={32} color="#1DA1F2" style={styles.socialIcon} />
        </TouchableOpacity>
        <TouchableOpacity onPress={() => console.log('Apple signup pressed')} activeOpacity={0.6}>
      ...
      {isSmallScreen ? (
        <TouchableOpacity onPress={() => navigation.navigate('Login')}>
          <Animated.Text style={[styles.alreadyText, animatedStyle]}>
